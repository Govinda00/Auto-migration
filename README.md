...
```
cd existing_repo
git remote add origin https://git.sarvika.com/govinda.kumar/devtool.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.sarvika.com/govinda.kumar/devtool/-/settings/integrations)
